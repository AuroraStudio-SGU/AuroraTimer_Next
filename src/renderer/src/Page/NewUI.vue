<template>
  <div class="menu">
    <div
      class="white-box overflow-auto"
      style="display: flex; align-items: center; justify-content: center"
    >
      <article class="leaderboard text-primary">
        <header>
          <svg
            version="1.1"
            id="Layer_1"
          ...
          <h1 class="leaderboard__title">
            <span class="leaderboard__title--top">极光工作室</span
            ><span class="leaderboard__title--bottom">卷王榜</span>
          </h1>
        </header>
        ...
        <main class="leaderboard__profiles">
          <article class="leaderboard__profile">
            ...
            />
            <span class="leaderboard__name">黄梓聪</span>
            <svg
              t="1685707164518"
              class="icon"
            ...
            <span class="leaderboard__value">100<span>H</span></span>
          </article>
          ...
          <article class="leaderboard__profile">
            <img
              ...
              class="leaderboard__picture"
            />
            <span class="leaderboard__name">陈典灿</span>
            <svg
              t="1685707465843"
              class="icon"
              viewBox="0 0 1024 1024"
            ...
            <span class="leaderboard__value">17.9<span>H</span></span>
          </article>
          ...
          <article class="leaderboard__profile">
            <img
              ...
              class="leaderboard__picture"
            />
            <span class="leaderboard__name">欧润丰</span>
            <svg
              t="1685707507600"
              class="icon"
              viewBox="0 0 1024 1024"
            ...
            <span class="leaderboard__value">1<span>H</span></span>
          </article>
        </main>
      </article>
    </div>
...
.leaderboard header {
  ...
  background-image: repeating-radial-gradient(
    ...
    linear-gradient(to right, hsl(var(--b1) / var(--tw-bg-opacity)), hsl(var(--b3, var(--b2)) / var(--tw-bg-opacity)));
...
.leaderboard__picture {
  ...
  width: 60px;
  border-radius: 50%;
  box-shadow: 0 0 0 10px hsl(var(--b3, var(--b2)) / var(--tw-bg-opacity)), 0 0 0 22px hsl(var(--b1) / var(--tw-bg-opacity));
}
.leaderboard__name {
